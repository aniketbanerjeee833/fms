...
import { getPaymentInsForPrint } from "../helpers/printReportHelpers.js";
...
//   }
// };
const getPaymentInPrintReport = async (
  req,
  res,
  next
) => {
