...
const states = [
 ...
 const [open, setOpen] = useState(false);
  ...
  setSearch(partyDetails.State ?? "");
  setSelected(partyDetails.State ?? null);
  ...
  reset({
    ...
    Opening_Balance:
      partyDetails.Opening_Balance ?? "",

    Opening_Balance_Type:
      partyDetails.Opening_Balance_Type ?? null,

    Opening_Balance_Date:
      partyDetails.Opening_Balance_Date ?? "",

    Credit_Limit_Type:
      partyDetails.Credit_Limit_Type ?? "No_Limit",

    Credit_Limit:
      partyDetails.Credit_Limit ?? "",

    addresses:
      partyDetails.addresses?.length > 0
        ? partyDetails.addresses
        : [],
  });
