...
import { useCreateExpenseCategoryMutation } from "../../redux/api/expenseApi";
import { toast } from "react-toastify";



export default function AddExpenseCategoryModal({ onClose, onSave }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success(res.message || "Expense category added successfully!");
      ...
      toast.error(
        err?.data?.message || "Failed to add expense category"
      );
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h4 className="text-xl font-semibold text-gray-900">Add Expense Category</h4>
          <button
            type="button"
