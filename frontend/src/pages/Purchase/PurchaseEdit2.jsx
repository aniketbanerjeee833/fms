...
firstMismatchHandledRef.current = false;
  ...
  // Used only for a newly-created party.
// Its first appearance must NOT use Party_Name
// as Billing_Name.
const skipFallbackForPartyIdRef = useRef(null);
      ...
      <div className="absolute z-20 flex flex-col mt-1 w-full bg-white border border-gray-300 rounded-md shadow-lg">
        ...
        <VirtualPartyScrollList
          ...
          onSelectParty={(party) => {
            ...
            // GSTIN / Phone / Billing Name
            // are handled by watchedPartyName effect.
          }}
        />
...
partyWasUserChangedRef.current = true;
        ...
        // IMPORTANT:
        //
        // Mark this party BEFORE setValue().
        //
        // Therefore the watch effect knows:
        // "This is a newly-created party's first appearance."
        //
        // If it has no Billing Name:
        // -> keep Billing Name empty
        // -> hide the field
        // -> don't use Party_Name
        skipFallbackForPartyIdRef.current =
          newParty.Party_Id;
