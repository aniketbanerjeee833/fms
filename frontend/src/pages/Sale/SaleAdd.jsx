...
import {
  itemApi, useAddCategoryMutation, useGetAllCategoriesQuery,
...
export default function SaleAdd() {
  ...
  const {
    ...
    search: partySearch,
    limit: 20,
    scope: "sale-form-dropdown",
  });
  console.log("DROPDOWN DEBUG:", { partySearch, partyCursor, partiesData, isPartiesFetching })
  ...
  console.log(activeSalePrefix, "activeSalePrefix", salePrefixes);
  ...
  const onSubmit = async (data) => {
    ...
    // const selectedPrefix = String(selectedSalePrefix || "").trim();
    // const enteredInvoiceNumber = String(data.Invoice_Number || "").trim();

    // let finalInvoiceNumber = enteredInvoiceNumber;

    // if (
    //   selectedPrefix &&
    //   selectedPrefix.toLowerCase() !== "none"
    // ) {
    //   finalInvoiceNumber = `${selectedPrefix}${enteredInvoiceNumber}`;
    // }
    // =========================================================
    // 6. BUILD PAYLOAD
    // =========================================================
                      ...
                      <div className="relative w-full">
                        ...
                        >
                          <input
                            ...
                            //       matchedParty.Billing_Name?.trim() ||
                            //       (enableBillingNameOfParties
                            //         ? matchedParty.Party_Name?.trim()
                            //         : "");

                            //     setBillingNameManuallyEntered(!!billingName);

                            //     setValue("Billing_Name", billingName, {
                            //       shouldValidate: true,
                            //       shouldDirty: true,
                            //     });
                            ...
                            onChange={(e) => {
                              ...
                              // =====================================================
                              // CLEAR PARTY SEARCH
                              // DO NOT CLEAR PHONE / BILLING NAME / BILLING ADDRESS
                              // WHILE TYPING
                              // =====================================================
                              ...
                              // =====================================================
                              // PARTY MATCH
                              // ONLY UPDATE GSTIN WHILE TYPING
                              // =====================================================

                              const matchedParty = parties.find(
                                (p) =>
                                  p.Party_Name?.trim()?.toLowerCase() ===
                                  value.trim().toLowerCase()
                              );
                            ...
                            onBlur={() => {
                              setTimeout(() => {
                                ...
                                if (matchedParty) {
                                  ...
                                  // =====================================================
                                  // CHECK CURRENTLY COMMITTED PARTY
                                  // =====================================================
                                  ...
                                  // =====================================================
                                  // NO EXACT PARTY MATCH / EMPTY PARTY
                                  // =====================================================
       ...
       ========================= */}
           ...
           ========================= */}
                            <VirtualPartyScrollList
                              //parties={selectedParty ? [selectedParty] : parties}
                              parties={parties}
                              isFetching={isPartiesFetching}
                ...
                <div className="flex flex-col gap-6 w-full lg:w-1/3">
                  ...
                  >
                    ...
                    <input
                      type="text"
                      id="Invoice_Number"
                      value={latestInvoiceNumber?.newInvoiceNumber || ""}
                      //{...register("Invoice_Number")}
                      placeholder="Invoice Number"
                      readOnly
                              ...
                              onBlur={() => {
                                setTimeout(async () => {
                                  ...
                                  try {
                                    ...
                                    //
                                    // IF MRP > 0:
                                    //     calculate from MRP - MRP discount
                                    //
                                    // IF MRP is 0/null:
                                    //     use master's Sale_Price
                                    // =====================================================
                                    ...
                                    // =====================================================
                                    // MASTER SALE PRICE DISCOUNT TYPE
                                    // =====================================================
                                    ...
                                    //     => matchedItem.Sale_Price
                                    //
                                    // NEVER blindly use matchedItem.Sale_Price
                                    // when MRP exists.
                                    // =====================================================
                                    ...
                                    // =====================================================
                                    // SALE PRICE DISCOUNT FROM MASTER
                                    // =====================================================
                                    ...
                                    // =====================================================
                                    // SALE PRICE DISCOUNT TYPE FROM MASTER
                                    // =====================================================
                                    ...
                                    // TAX TYPE
                                    //
                                    // Keep your existing current-row tax if present.
                                    // Otherwise use master tax if available.
                                    // Otherwise None.
                                    // =====================================================
                                    ...
                                    //
                                    // ADD SALE:
                                    // preserve whatever is currently in the row.
                                    // If empty, use 1.
                                    // =====================================================
                                    ...
                                    baseSalePriceRef.current[i] =
                                      Number(calculatedMasterSalePrice) || 0;
                            ...
                            {rows[i]?.itemOpen && (
                              <ItemDropdownVirtualized
                                ...
                                onSelectItem={(it) => {
                                  ...
                                  // =====================================================
                                  // MASTER SALE DISCOUNT
                                  // Add Sale has no existing transaction value to preserve,
                                  // so use the master discount if it is > 0.
                                  // =====================================================
                                  ...
                                  // =====================================================
                                  // IMPORTANT:
                                  // DO NOT SET Quantity = 1
                                  // Keep whatever quantity is already in this row.
                                  // =====================================================

                                  const currentQuantity =
                                    itemsValues[i]?.Quantity || 1;
                                  ...
                                  //
                                  // IMPORTANT:
                                  // Do NOT pass MRP here.
                                  // Only pass Sale_Price, Quantity, Sale discount, Tax etc.
                                  // =====================================================
                                    ...
                                    calculateRowAmount(
                                      {
                                        ...
                                        Tax_Type:
                                          it.Tax_Type || itemsValues[i]?.Tax_Type || "None",
